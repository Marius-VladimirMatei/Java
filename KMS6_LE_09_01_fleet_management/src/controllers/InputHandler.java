    ...
    public void handleAddVehicle() {
        ...
        switch (type) {
            case 1:
                ...
                vehicleController.addVehicle(new Car(licensePlate, mileage, carFuel, doors));
                break;
            case 2:
                ...
                vehicleController.addVehicle(new Truck(licensePlate, mileage, truckFuel, capacity));
                break;
            case 3:
                System.out.print("Has sidecar? (yes/no): ");
                boolean sidecar = scanner.nextLine().equalsIgnoreCase("yes");
                System.out.print("Enter current fuel level: ");
                double motoFuel = Double.parseDouble(scanner.nextLine());
                vehicleController.addVehicle(new Motorcycle(licensePlate, mileage, motoFuel, sidecar));
                break;
            case 4:
